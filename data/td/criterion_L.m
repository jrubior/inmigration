function res = criterion_L(Y,x,ta,type,opC,rl,X,C,N,n)
% PURPOSE: Evaluate the objective function for Litterman method
% ------------------------------------------------------------
% SYNTAX: res = criterion_L(Y,x,ta,type,opC,rl,X,C,N,n);
% ------------------------------------------------------------
...
% ------------------------------------------------------------
% INPUT: elements used by litterman_W(). See its source code.
% ------------------------------------------------------------
% LIBRARY: 
% ------------------------------------------------------------
% SEE ALSO: criterion_CL
