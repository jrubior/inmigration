function loglik_prop = loglike_B(z_prop,function_restrictions,Sigmadraw,Qdraw,setup)
...
B_prop = reshape(z_prop,setup.m,setup.nvar);




S_prop = function_restrictions(B_prop, Sigmadraw, Qdraw,setup);
