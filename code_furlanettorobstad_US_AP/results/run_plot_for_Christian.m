...
for ii=1:nhorizons
    for jj=1:nvar
        ...
        if jj==15
            ...
            Lcmy_q50(ii,15,kk) = quantile(Lcmy.store_response(:,15,kk,ii)-Lcmy.store_response(:,11,kk,ii),0.5); % real wage 15 - 11
            Lcmy_q16(ii,15,kk) = quantile(Lcmy.store_response(:,15,kk,ii)-Lcmy.store_response(:,11,kk,ii),0.16);
            Lcmy_q84(ii,15,kk) = quantile(Lcmy.store_response(:,15,kk,ii)-Lcmy.store_response(:,11,kk,ii),0.84);
...
% hold on
hzero=plot([0:horizon],auv50*0,'r-.','linewidth',0.5);
hold on
...
print(['epsfiles/',num2str(spec),'_shock_demand_CMY.eps'],'-depsc');
print(['pngfiles/',num2str(spec),'_shock_demand_CMY.png'],'-dpng');
