function y = logmvnpdf_mc(X, Mu, Sigma)
...
%yBeforeNaNCheck = exp(-0.5*quadform - logSqrtDetSigma - d*log(2*pi)/2);
yBeforeNaNCheck = (-0.5*quadform - logSqrtDetSigma - d*log(2*pi)/2);
