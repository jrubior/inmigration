function [z_old, lik_old, n_try, Bnew,Signew,Anew,Bstrnew] = slice_sampling_v02_kron_BSig(slice, z_old, lik_old)

% use kronecker structure in chol_cov_z
% slice.chol_cov_z = kron(chol_cov_z1, chol_cov_z2)
...
unvec_v = slice.chol_cov_z2 * randn(slice.nobs2, slice.nobs1) * slice.chol_cov_z1';
v = unvec_v(:);
% ----
...
[lik_new,Bnew,Signew,Anew,Bstrnew] = slice.fcn_lik(z_new);
valid = 0;
n_try = 1;
