function [z_old, lik_old, n_try, Bnew, Signew, Anew,Bstrnew] = slice_sampling_v02_Sigma_BSig(slice, z_old, lik_old)

% Sigma: optimized for Sigma updating
...
unvec_v = slice.chol_cov_z_common * randn(slice.nobs1, slice.nobs2);
v = unvec_v(:);
