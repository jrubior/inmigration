function loglik_prop = loglike_Sigma_mc(z_prop,function_restrictions,fo_inv,fo_str2irfs,Bdraw,Qdraw,info,nnuTilde,mmuTilde,chol_lower_OomegaTilde,chol_lower_OomegaTilde_inv)
